 ...
 */
class UpdateManager(
    private val githubRepo: String = "Hinana0325/Agent-Control-Center"
) {
    ...
    fun downloadUpdate(context: Context, info: UpdateInfo) {
        val filename = "agentcontrolcenter-v${info.version}.apk"
        val request = DownloadManager.Request(Uri.parse(info.downloadUrl))
            .setTitle("Agent Control Center v${info.version}")
